// export {}; // incluído para resolver o problema Cannot redeclare block-scoped variable 'saldoTS'. Isso acontece porque ao gerar o arquivo em JS, ele duplica o nome da variável
var saldoTS = 3000;
...
//     elementoSaldo.textContent = saldoTS.toString();
// }
var elementoFormularioTS = document.querySelector(".block-nova-transacao form");
elementoFormularioTS.addEventListener("submit", function (event) {
    ...
    var inputTipoTransacao = elementoFormularioTS.querySelector("#tipoTransacao");
    var inputValor = elementoFormularioTS.querySelector("#valor");
    var inputData = elementoFormularioTS.querySelector("#data");
    var tipoTransacao = inputTipoTransacao.value;
    var valor = inputValor.valueAsNumber; // valueAsNumber é uma propriedade existente nos Inputs
